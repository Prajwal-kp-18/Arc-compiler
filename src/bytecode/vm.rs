...
mod tests {
    ...
    fn test_golden_suite_parity() {
        ...
        let programs = [
            ...
            "min(3.5, 2, 4.1);",
            r#"int("42"); int(3.9); float("3.5"); str(42);"#,
            r#"len("hello"); substr("hello world", 6, 5); find("hello", "ll");"#,
            r#"upper("hi"); lower("HI"); trim("  hi  "); char_at("hi", 1);"#,
            r#"ord("A"); chr(65);"#,
            "abs(-5); abs(-5.5); sqrt(16.0); floor(3.7); ceil(3.2); round(3.5);",
            r#"assert(1 + 1 == 2, "math broke");"#,
            "fn f() { 7; } f();",
